/*
 * math_lib_test.c — Test harness for the math library
 *
 * This file includes math_lib.h and tests each function with known inputs.
 * If all tests pass, it prints a success message. If any test fails,
 * it prints which test failed and stops.
 *
 * Build (you need both .c files):
 *   gcc -Wall -Wextra -pedantic -std=c99 math_lib.c math_lib_test.c -o math_lib_test
 *
 * This is your first multi-file program! Two .c files compiled together.
 */
