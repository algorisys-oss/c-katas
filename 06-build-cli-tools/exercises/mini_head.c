...
int main(int argc, char *argv[]) {
     ...
     *
     * 1. Set max_lines = DEFAULT_LINES (10).
     *
     * 2. Parse arguments starting at argv[1]:
     *    - If argv[i] is "-n", then argv[i+1] is the number.
     *      Set max_lines = atoi(argv[i+1]). Advance i by 2.
     *    - Otherwise, argv[i] is the filename.
     *
     * 3. Open the file or use stdin (same pattern as mini_wc).
     *
     * 4. Call head_stream(input, max_lines, stdout).
     *
     * 5. Clean up and return 0.
     *
     * Skeleton:
     *
