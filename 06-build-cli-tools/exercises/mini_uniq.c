...
int main(int argc, char *argv[]) {
     ...
     *    While argv[i] starts with '-', check for -c and -d.
     *    Store them in a uniq_opts struct.
     *
     * 2. After flags, if there is another argument, it is the filename.
     *    Open it with fopen. If it fails, print error and return 1.
     *    If no filename, use stdin.
     *
     * 3. Call uniq_stream(input, opts, stdout).
     *
     * 4. Clean up and return 0.
     *
     * Skeleton:
     *
     * uniq_opts opts = {0, 0};
